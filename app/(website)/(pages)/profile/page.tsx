          ...
          <Card className="text-center p-4">
            <CardContent className='space-y-4'>
              ...
              <ul className="space-y-2 text-start">
                <li className="text-gray-700 font-medium flex items-center gap-2 cursor-pointer" onClick={() => scrollToSection(profileRef)}>
                  <User size={16} /> Personal Info
                </li>
                <li className="text-gray-700 font-medium flex items-center gap-2 cursor-pointer" onClick={() => scrollToSection(settingsRef)}>
                  <Settings size={16} /> Settings
                </li>
                <li className="text-red-500 cursor-pointer" onClick={handleLogout}>Log Out</li>
              </ul>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="w-full md:w-3/4 space-y-4">
              ...
              <table className='w-full table-fixed'>
                <tbody>
                  {profileData.map((item, index) => (
                    <tr key={index}>
                      <td className="font-medium text-gray-700 py-2 capitalize">{item.label}</td>
          ...
          <Card ref={settingsRef}>
            <CardHeader>
              ...
              <p className="text-sm text-gray-500">Manage your email address, mobile number and password</p>
            </CardHeader>
            <CardContent>
            <table className='w-full table-fixed'>
                <tbody>
                  ...
                  <tr>
                    <td className="font-medium text-gray-700 py-2 capitalize">Password</td>
                    <td className="text-[#020842] py-2 font-bold cursor-pointer">Change Password ?</td>
                  </tr>
                </tbody>
              </table>
            </CardContent>
